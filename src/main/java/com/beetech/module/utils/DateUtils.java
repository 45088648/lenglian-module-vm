...
public class DateUtils {
	...
	public static final String C_YYYY_MM_DD_HH_MM_SS1 = "yyyy-MM-dd-HH-mm-ss";
	...
	public static final String C_MM_DD_HH_MM_SS_SSS = "MM/dd HH:mm:ss SSS";
	public static final String C_MM_DD_HH_MM_SS = "MM/dd HH:mm:ss";
	public static final String C_MM_DD_HH_MM = "MM/dd HH:mm";

	public static final String C_HHMMSS = "HH:mm:ss";
	public static final String C_HHMMSS1 = "HHmmss";
